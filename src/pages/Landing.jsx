...
import { Search, Youtube, ChevronRight, Target, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="h-screen w-full bg-[#020202] text-white overflow-hidden relative flex flex-col items-center justify-center font-sans selection:bg-red-600/40">
      ...
      <motion.div 
        ...
        className="absolute top-12 flex items-center gap-3 px-5 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md"
      >
        <Youtube className="text-red-600" size={18} fill="currentColor" />
        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400">Neural Video Indexer v2.0</span>
      </motion.div>
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <motion.h2 
              ...
              className="text-4xl md:text-7xl font-black italic uppercase tracking-tighter text-center"
            >
              Don't Watch. <span className="text-red-600">Extract.</span>
            </motion.h2>
          </div>
        </motion.div>
