...
import Explore from './pages/Explore'; // Import your new Explore component
...
const ResultsView = ({ query }) => {
  ...
  return (
    <motion.div 
      initial={{ opacity: 0 }} 
      animate={{ opacity: 1 }} 
      exit={{ opacity: 0 }} // Added exit for AnimatePresence
    ...
    >
      <header className="flex justify-between items-center mb-12">
        ...
        <div className="bg-white/5 px-4 py-2 rounded-full border border-white/10 text-sm text-white">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div className="aspect-video bg-gray-900 rounded-3xl border border-white/10 overflow-hidden relative group">
            <div className="absolute inset-0 flex items-center justify-center bg-black/40 opacity-100 group-hover:opacity-0 transition-opacity">
              <div className="text-center">
                ...
                <div className="w-16 h-16 border-2 border-cyan-500 rounded-full flex items-center justify-center mx-auto">
          ...
          <h2 className="text-2xl font-bold text-white">The moment of discovery</h2>
        ...
        <div className="space-y-4">
          ...
          {[1, 2, 3].map((i) => (
            ...
            >
              <p className="text-sm font-medium mb-1 text-white">Related Timestamp {i}:00</p>
